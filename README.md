...
1. [Queries](#queries)
   - 1.1. [Top Rankings](#top-rankings)
      - 1.1.1. [Top 10 Most Rented Films](#1-top-10-most-rented-films)
      - 1.1.2. [Top 5 Popular Categories per Store](#2-top-5-popular-categories-per-store)
      - 1.1.3. [Top 10 Overall Customers](#3-top-10-overall-customers)
      - 1.1.4. [Top 10 Customers per Store](#4-top-10-customers-per-store)
   - 1.2. [Revenue and Rentals](#revenue-and-rentals)
      - 1.2.1. [Total Revenue per Store](#5-total-revenue-per-store)
      - 1.2.2. [Store Revenue and Average Revenue per Customer](#6-store-revenue-and-average-revenue-per-customer)
      - 1.2.3. [Store Total Rentals and Average Rentals per Customer](#7-store-total-rentals-and-average-rentals-per-customer)
   - 1.3. [Customers](#customers)
      - 1.3.1. [Customers Rented from Both Stores](#8-customers-rented-from-both-stores)
      - 1.3.2. [Top 10 customers who spend the most per store](#9-top-10-customers-who-spend-the-most-per-store)
      - 1.3.3. [Top 10 customers who spend the most overall](#10-top-10-customers-who-spend-the-most-overall)
   - 1.4. [Films and Actors](#films-and-actors)
      - 1.4.1. [Total and Average Rental Duration per Category](#11-total-and-average-rental-duration-per-category)
      - 1.4.2. [Actors in More Than 10 Films](#12-actors-in-more-than-10-films)
2. [Usage](#usage)
3. [License](#license)
